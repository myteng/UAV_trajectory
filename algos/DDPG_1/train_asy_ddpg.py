...
if __name__ == '__main__':
    ...
    if args_env.use_potential_reward:
        log_dir_log = "../../log_data/ddpg_1/"
        log_dir_bp = "../../log_bp_data/ddpg_1/"
    else:
        log_dir_log = "../../log_data/ddpg_no_potential_1/"
        log_dir_bp = "../../log_bp_data/ddpg_no_potential_1/"

    epoch_set, rewards_set = training_asy_ddpg(1600, log_dir_log, log_dir_bp)
